...
public class linkedin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); //https://www.linkedin.com/uas/login?_l=en

        insta =(WebView) findViewById(R.id.linkedin_webview);
        ...
        insta.loadUrl("https://www.linkedin.com/uas/login?_l=en");
    }
    @Override
